...
// Load dependencies
__webpack_require__(/*! ./bootstrap */ "./resources/js/web/bootstrap.js"); // Plugins and libraries


__webpack_require__(/*! ./vendor/simplebar.js */ "./resources/js/web/vendor/simplebar.js"); // Modules
...
var Booking = function () {
  ...
  var _registerAndStoreBooking = function _registerAndStoreBooking() {
    var form = $(selectors.formRegister); // Gather form data
...
var Notify = function () {
  ...
  * ------------------------------------------------------------ */
  ...
  var _error = function _error(msg, parent, errors) {
    ...
    _hide(); // initialize error string


    var errorStr = ''; // loop all errors and add to error string
    ...
    var tpl = templates.danger.replace("%msg%", m); // add errors to errors container
...
__webpack_require__(/*! /Users/marceli.to/Jamon.digital/Webroot/sipt.ch/resources/js/web/app.js */"./resources/js/web/app.js");
__webpack_require__(/*! /Users/marceli.to/Jamon.digital/Webroot/sipt.ch/resources/sass/web/app.scss */"./resources/sass/web/app.scss");
