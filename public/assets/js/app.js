...
__webpack_require__(/*! ./vendor/simplebar.js */ "./resources/js/web/vendor/simplebar.js");
...
__webpack_require__(/*! ./modules/loader.js */ "./resources/js/web/modules/loader.js");
__webpack_require__(/*! ./modules/booking.js */ "./resources/js/web/modules/booking.js");
__webpack_require__(/*! ./modules/auth.js */ "./resources/js/web/modules/auth.js");
__webpack_require__(/*! ./modules/notify.js */ "./resources/js/web/modules/notify.js");
...
/***/ "./resources/js/web/modules/auth.js":
/*!******************************************!*\
  !*** ./resources/js/web/modules/auth.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loader */ "./resources/js/web/modules/loader.js");
/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./notify */ "./resources/js/web/modules/notify.js");
    ...
    if (_validate(formData)) {
      ...
      $.ajax({
        ...
        error: function error(data) {
          _loader__WEBPACK_IMPORTED_MODULE_0__["default"].hide();
          _notify__WEBPACK_IMPORTED_MODULE_1__["default"].error('Es sind Fehler aufgetreten.', '.js-booking-form', data.responseJSON.errors);
        }
      });
    }
  };
  var _validate = function _validate(formData) {
    var valid = true,
      validationErrors = [];
    if (formData.email == '') {
    ...
    if (!valid) {
      _notify__WEBPACK_IMPORTED_MODULE_1__["default"].error('Es sind Fehler aufgetreten.', '.js-booking-form', validationErrors);
      return false;
    }
    return true;
  };
...
/***/ "./resources/js/web/modules/booking.js":
/*!*********************************************!*\
  !*** ./resources/js/web/modules/booking.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Booking = function () {
  ...
  var _addBooking = function _addBooking(event) {
    _loader__WEBPACK_IMPORTED_MODULE_0__["default"].show();
  ...
  var _destroyBooking = function _destroyBooking(event) {
  ...
  var _registerAndStoreBooking = function _registerAndStoreBooking() {
    ...
    if (_validate(formData)) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          _reset();
          _loader__WEBPACK_IMPORTED_MODULE_0__["default"].hide();
          _notify__WEBPACK_IMPORTED_MODULE_1__["default"].success('Vielen Dank für Ihre Anmeldung. Die Bestätigung für den/die Kurse folgt in Kürze per Mail', '.js-booking-form');
        },
        error: function error(data) {
          _loader__WEBPACK_IMPORTED_MODULE_0__["default"].hide();
          _notify__WEBPACK_IMPORTED_MODULE_1__["default"].error('Es sind Fehler aufgetreten.', '.js-booking-form', data.responseJSON.errors);
  ...
  var _storeBooking = function _storeBooking() {
    _loader__WEBPACK_IMPORTED_MODULE_0__["default"].show();
    $.ajax({
      url: '/booking',
      method: 'post',
  ...
  var _refreshBookings = function _refreshBookings(data) {
    if (data.length == 0) {
      $(selectors.listing).html('');
      $(selectors.counter).html('');
  ...
  var _toggleAuthForm = function _toggleAuthForm(btn) {
  ...
  var _toggleRegisterForm = function _toggleRegisterForm(btn) {
...
/***/ "./resources/js/web/modules/loader.js":
/*!********************************************!*\
  !*** ./resources/js/web/modules/loader.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/web/modules/notify.js":
/*!********************************************!*\
  !*** ./resources/js/web/modules/notify.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Notify = function () {
  ...
  * ------------------------------------------------------------ */
  ...
  var templates = {
    danger: '<div class="alert alert--danger js-notify">' + '<div>%msg%</div>' + '%errors%' + '</div>',
    success: '<div class="alert alert--success js-notify">' + '<div>%msg%</div>' + '</div>'
  };
  ...
  * ------------------------------------------------------------ */
   ...
   * @param array errors 
   */
  var _error = function _error(msg, parent, errors) {
   ...
   * @param string parent 
   */
  var _success = function _success(msg, parent) {
    // hide previously shown notifications
    _hide();
...
/***/ "./resources/js/web/vendor/simplebar.js":
/*!**********************************************!*\
  !*** ./resources/js/web/vendor/simplebar.js ***!
  \**********************************************/
...
!function (t, e) {
  ...
  var Qt = Object.keys || function (t) {
    ...
    _ee = function ee() {
      var t,
        e = A("iframe"),
        r = ht.length;
      for (e.style.display = "none", Jt.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), _ee = t.F; r--;) delete _ee.prototype[ht[r]];
      return _ee();
    },
  ...
  function Fn(t, e) {
    ...
    var _r2 = function r() {
      ...
      return _r2.cache = o.set(i, s), s;
    };
    return _r2.cache = new (Fn.Cache || Nn)(), _r2;
  }
  function Bn(t) {
    var e = _typeof(t);
    return !!t && ("object" == e || "function" == e);
...
/******/ 	__webpack_require__.O(undefined, ["assets/dashboard/css/app","assets/css/app"], () => (__webpack_require__("./resources/js/web/app.js")))
/******/ 	__webpack_require__.O(undefined, ["assets/dashboard/css/app","assets/css/app"], () => (__webpack_require__("./resources/sass/web/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/dashboard/css/app","assets/css/app"], () => (__webpack_require__("./resources/sass/dashboard/app.scss")))
