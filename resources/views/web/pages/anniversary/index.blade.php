...
<section class="theme-light">
  ...
  <article>
    <h2>20 Jahre SIPT</h2>
    <p>Das SIPT wird dieses Jahr 20 Jahre alt! Dies möchten wir mit einer zweitägigen Fachtagung feiern und laden Sie herzlich dazu ein. Gemeinsam widmen wir uns dem Thema <a href="{{ asset('storage/downloads/sipt-tagung-2026-v2') }}" target="_blank"><strong>«Soziale Traumata und deren Auswirkungen in der Praxis»</strong></a>.</p>
