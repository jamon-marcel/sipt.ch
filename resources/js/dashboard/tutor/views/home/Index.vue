<template>
  <div :class="isFetched ? 'is-loaded' : 'is-loading'">
    <header class="content-header">
      <h1>Willkommen <strong>{{tutor.firstname}} {{tutor.name}}</strong></h1>
    </header>
    <div class="content">
      ...
      <course-events-list :records="courseEvents" :isTutor="true" :hasDestroy="false"></course-events-list>
...
export default {
  ...
  methods: {
    fetch() {
      this.axios.get(`/api/tutor/course/events`).then(response => {
